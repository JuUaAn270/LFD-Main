              ...
              <div class="col-lg-6">
                <div class="card-body p-md-5 mx-md-4">
                  ...
                  if ($usuario && $password) {
                    ...
                    $query = "SELECT COUNT(*) FROM cliente WHERE username = $1 AND password = $2";
                    $query_id = "SELECT id_usuario FROM cliente WHERE username = $1 AND password = $2";
                    $result = pg_query_params($conn, $query, array($usuario, $password));
                    $result_id = pg_query_params($conn, $query_id, array($usuario, $password));
                  ...
                  <form method="post">
                    <div class="form-outline mb-4">
                      <input type="text" id="form2Example11" class="form-control" name="usuario" placeholder="Introduce tu usuario" />
                    </div>
                    ...
                    <div class="text-center pt-1 mb-5 pb-1">
                      ...
                      <a class="mb-0 me-2 text-muted" href="loginhostelero.php">Soy Hostelero</a>
                    </div>
                  </form>
                  ...
                  <div class="d-flex align-items-center justify-content-center pb-4">
                    ...
                    <button type="button" class="btn btn-warning mx-3" style="width: 200px;"><a style="text-decoration: none;" class="text-black" href="register.php">Crear una cuenta</a></button>
                  </div>
