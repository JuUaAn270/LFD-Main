...
-- -------------------------------------------------------------------------------------------------------------------------------------
-- Para Montar la BD primero ejecutar insert.sql y posteriormente update.sql para establecer las imágenes en los productos.
-- -------------------------------------------------------------------------------------------------------------------------------------
BEGIN;
...
ALTER TABLE IF EXISTS public.producto
    ADD CONSTRAINT "Producto_ID_País_fkey" FOREIGN KEY (id_pais)
